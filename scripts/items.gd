...
onready var fuel_can = I.new("fuel_can","An empty gas can.","A red gas canister with a warning label: \u201cFor chainsaws only!\u201d. It's empty.","res://images/fuel_can_inv.png")
